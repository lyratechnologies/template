...
- Use cases are plain functions with per-use-case ports and typed output states.
- tRPC routers, Prisma implementations, and React containers are adapters around those use cases.
