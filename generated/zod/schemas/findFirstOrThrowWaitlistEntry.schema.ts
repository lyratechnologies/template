...
export const WaitlistEntryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WaitlistEntrySelect> = z.object({
...
export const WaitlistEntryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    position: z.boolean().optional(),
    promotedAt: z.boolean().optional(),
    cancelledAt: z.boolean().optional(),
...
export const WaitlistEntryFindFirstOrThrowSchema: z.ZodType<Prisma.WaitlistEntryFindFirstOrThrowArgs> = z.object({ select: WaitlistEntryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => WaitlistEntryIncludeObjectSchema.optional()), orderBy: z.union([WaitlistEntryOrderByWithRelationInputObjectSchema, WaitlistEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WaitlistEntryWhereInputObjectSchema.optional(), cursor: WaitlistEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WaitlistEntryScalarFieldEnumSchema, WaitlistEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WaitlistEntryFindFirstOrThrowArgs>;

export const WaitlistEntryFindFirstOrThrowZodSchema = z.object({ select: WaitlistEntryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => WaitlistEntryIncludeObjectSchema.optional()), orderBy: z.union([WaitlistEntryOrderByWithRelationInputObjectSchema, WaitlistEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WaitlistEntryWhereInputObjectSchema.optional(), cursor: WaitlistEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WaitlistEntryScalarFieldEnumSchema, WaitlistEntryScalarFieldEnumSchema.array()]).optional() }).strict();