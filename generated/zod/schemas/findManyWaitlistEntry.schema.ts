...
export const WaitlistEntryFindManySelectSchema: z.ZodType<Prisma.WaitlistEntrySelect> = z.object({
...
export const WaitlistEntryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    position: z.boolean().optional(),
    promotedAt: z.boolean().optional(),
    cancelledAt: z.boolean().optional(),
