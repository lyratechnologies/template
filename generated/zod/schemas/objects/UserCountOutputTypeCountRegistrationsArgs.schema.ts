...
export const UserCountOutputTypeCountRegistrationsArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountRegistrationsArgsObjectZodSchema = makeSchema();
