...
export const UserCountOutputTypeCountWaitlistEntriesArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountWaitlistEntriesArgsObjectZodSchema = makeSchema();
